...
\label{sec:orgc8a2228}

\subsection{Orders of Governance}
\label{sec:org730ac77}
...
\label{sec:org56bff48}

\subsection{Records}
\label{sec:org7a2aadf}

The records of the chapter, which include chapter correspondence, membership signature book, financial records (including checkbooks), chapter meeting minutes and other records deemed important, shall be located at 290 Cory.

\subsection{Trustees}
\label{sec:orgdff4fb1}
...
\label{sec:org22b4876}

Candidates who are graduate students, faculty members, or professionals must have the written approval and endorsement of the chapter faculty advisor and the head of the EECS department.

\subsection{Miscellaneous}
\label{sec:org3ce64dc}

We will not haze according to California State Law, Federal Law, and UC Berkeley's Code of Student Conduct.

Hazing activities can cause, or are likely to cause, physical injury, personal degradation, disgrace, humiliation, or endangering behavior resulting in psychological, mental, physical, emotional, and/or academic harm to any student or other person, or the destruction of property. 

The University of California, Berkeley’s Code of Student Conduct defines hazing as:
...
Hazing is prohibited per the University of California, Berkeley, the State of California, and Federal law. Learn more on the UC Berkeley Dean of Students Hazing Laws \& Policies page.
...
\section{Officers}
\label{sec:orgd6999df}

\subsection{Terms of Service}
\label{sec:orgd8ab27f}
...
\label{sec:org643dab1}

\subsection{Order of Election}
\label{sec:org8a529b1}
...
\label{sec:org03210a4}

The President shall oversee the operations of the entirety of HKN.


The External Vice President shall oversee the operations of the candidate process of HKN.
 
The Internal Vice President shall oversee the operations of the general HKN member body and the relations between the chapter and alumni.

The Recording Secretary shall ensure proper meeting procedure and oversee general member logistics.
...
\end{enumerate}
\section{Meetings}
\label{sec:org75f2924}

\subsection{Quorum}
\label{sec:orgdb2e294}
...
\label{sec:orga7dd37e}

\subsection{National Induction Fee}
\label{sec:orgedafecf}
...
\label{sec:org2389317}

This organization hereby wishes to seek ASUC sponsorship.
This organization adopts and incorporates by reference Schedule A of ASUC Bylaw 2201, and the same as may be amended from time by time, completely and fully as part of this constitution.
...
13 This organization shall be considered dissolved if it is inactive and (a) fails to register as a student organization with the University for more than five full academic years or (b) it ceases to have any members.
